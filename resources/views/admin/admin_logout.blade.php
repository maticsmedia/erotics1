...
<html lang="en">
    ...
    <head>
        ...
        <!-- Head js -->
        <script src="{{ asset('build/js/head.js') }}"></script>
<!-- toastr -->
...
<!-- toastr -->
    ...
    <body class="authentication-bg authentication-bg-pattern">
        ...
        <div class="text-center w-75 m-auto">
            <div class="auth-logo">
                <a href="index.html" class="logo logo-dark text-center">
                    <span class="logo-lg">
                        <img src="{{ asset('build/images/logo-dark.png') }}" alt="" height="22">
                    </span>
                </a>

                <a href="index.html" class="logo logo-light text-center">
                    <span class="logo-lg">
                        <img src="{{ asset('build/images/logo-light.png') }}" alt="" height="22">
                    </span>
                </a>
            </div>
        </div>
       ...
       <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; Lucie <a href="" class="text-white-50">Lucie Jewelry</a>
        </footer>
