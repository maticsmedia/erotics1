                ...
                <p><strong>{{ $profile->name }}</strong>
                    @if($profile->verified)
                        <span class="badge verified-personal-badge">
                            <img src="{{ asset('assets/assets/icon/check.png') }}" alt="Verified Badge" width="16" height="16">
                        </span>
                    @endif
                </p>
                <span class="badge location-badge"><i class="fas fa-map-marker-alt"></i> {{ $profile->address }}</span>
            </div>
        </div>
    @endforeach
